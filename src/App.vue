...
.info-panel         { padding: 7px 7px; display: flex; justify-content: space-around; align-items: center; font-size: 1.0em; color: #FFFFFFFF; background-color: #E9E9E9FF; border-radius: 6px; cursor: default; }
...
.infop-item-icon    { font-size: 14px; }
.info-toggle        { display: inline-block; width: 26px; text-align: center; cursor: pointer; color: #2288AAFF; background-color: #FFFFFFCC; }
.info-toggle:hover  { background-color: #FFFFFF66; }
